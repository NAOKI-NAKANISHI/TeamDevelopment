...
public class CartInfoDAO {
	...
	/*
	 *
	 * try-with-resourcesはtryブロックの開始と同時に生成するものしかAutoCloseableで実装できない
	 * Statementは使用可能だがpreparedStatementは使用不可
	 * tryをネストすることで以下のように記述自体は可能だがネストが深くなってしまい、冗長化を避けるための
	 * try-with-resourcesを活かしきれていない問題が発生する、
	 *
	 * try (
	...
	public List<CartInfoDTO> getCartInfoDtoList(String loginId) {
		...
		product_count: 2
		price: 200
		regist_date: 2018-10-04 13:21:35
		update_date: 2018-10-04 13:21:35
		product_name: 本２
		product_name_kana: ほん２
		product_description: 本２の商品詳細
		category_id: 2
		image_file_path: ./images
		image_file_name: sample.jpg
		release_date: 2018-10-04 13:21:35
